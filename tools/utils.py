...
def CaclTP(imPred, imLab, numClass):
    ...
    (lab_hist, weight) = np.histogram(imLab, bins=numClass, range=(1, numClass+1))
    # print("pred_hist{}\n, imPred{}\n, lab_hist{}\n, imLab{}".format(pred_hist[0:10], imPred[0:10], lab_hist[0:10],imLab[0:10]))
