...
class WindowAttention(nn.Module):
    ...
    def extra_repr(self):
        return 'dim={}, window_size={}, num_heads={}'.format(self.dim, self.window_size, self.num_heads)
...
class SwinTransformerBlock(nn.Module):
    ...
    def extra_repr(self):
        return "dim={}, input_resolution={}, num_heads={}".format(self.dim, self.input_resolution, self.num_heads),\
               "window_size={}, shift_size={}, mlp_ratio={}".format(self.window_size, self.shift_size, self.mlp_ratio)
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=256, patch_size=4, in_chans=3, num_classes=7,
    ...
    def forward_trans(self, x):
        ...
        trans_x = x
        trans_x = self.patch_embed(trans_x)  # [12, 4096, 96]
        i_layer = 0
        ...
        for layer in self.layers:
            ...
            Trans_x = self.Conv3[i_layer](Trans_x)
            # Trans_x = F.interpolate(Trans_x, x_size[2:], mode='bilinear', align_corners=True)
