...
# from models.ResNet_50 import ResNet_50 as FCN
...
class Patch_Attention(nn.Module):
    def __init__(self, in_channels, reduction=2, pool_window=12, add_input=False):
...
class Patch_AttentionV2(nn.Module):
    def __init__(self, in_channels, reduction=4, pool_window=12, add_input=False):
...
class Mynet(nn.Module):
    ...
    def forward(self, x):
        ...
        x2 = self.head(x)  #size:1/16 or 1/32, C128
